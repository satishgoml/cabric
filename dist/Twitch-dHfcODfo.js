import { g as w, u as D, p as C } from "./index-6nBHXAT7.js";
import N from "react";
function I(t, e) {
...
var S = Object.create, l = Object.defineProperty, j = Object.getOwnPropertyDescriptor, A = Object.getOwnPropertyNames, M = Object.getPrototypeOf, R = Object.prototype.hasOwnProperty, H = (t, e, r) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, x = (t, e) => {
  for (var r in e)
  ...
  t
)), U = (t) => _(l({}, "__esModule", { value: !0 }), t), n = (t, e, r) => (H(t, typeof e != "symbol" ? e + "" : e, r), r), P = {};
x(P, {
  default: () => h
});
...
class h extends y.Component {
  constructor() {
    super(...arguments), n(this, "callPlayer", c.callPlayer), n(this, "playerID", this.props.config.playerId || `${$}${(0, c.randomString)()}`), n(this, "mute", () => {
  ...
  load(e, r) {
    const { playsinline: s, onError: a, config: o, controls: v } = this.props, i = u.MATCH_URL_TWITCH_CHANNEL.test(e), p = i ? e.match(u.MATCH_URL_TWITCH_CHANNEL)[1] : e.match(u.MATCH_URL_TWITCH_VIDEO)[1];
    if (r) {
